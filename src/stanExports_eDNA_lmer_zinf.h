...
namespace model_eDNA_lmer_zinf_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_eDNA_lmer_zinf");
    reader.add_event(74, 72, "end", "model_eDNA_lmer_zinf");
    return reader;
}
#include <stan_meta_header.hpp>
class model_eDNA_lmer_zinf
  : public stan::model::model_base_crtp<model_eDNA_lmer_zinf> {
private:
        int N_obs;
        int N_cens;
        int K;
        ...
        int has_inter;
public:
    model_eDNA_lmer_zinf(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_eDNA_lmer_zinf_namespace::model_eDNA_lmer_zinf";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_eDNA_lmer_zinf_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_eDNA_lmer_zinf_namespace::model_eDNA_lmer_zinf stan_model;
#ifndef USING_R
