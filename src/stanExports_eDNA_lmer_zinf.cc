...
#include "stanExports_eDNA_lmer_zinf.h"

RCPP_MODULE(stan_fit4eDNA_lmer_zinf_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_eDNA_lmer_zinf")
